...
n1name=$(ssh remoteadmin@server1-mgmt --  grep loghost /var/log/syslog | wc -l)
n1ip=$(ssh remoteadmin@server1-mgmt --  grep "192.168.16.3" /var/log/syslog | wc -l)
n1entry=$(ssh remoteadmin@server1-mgmt --  grep "192.168.16.4 webhost" /var/log/syslog | wc -l)
echo "n1name=$n1name  n1ip=$n1ip  n1entry=$n1entry"
...
n2name=$(ssh remoteadmin@server1-mgmt --  grep loghost /var/log/syslog | wc -l)
n2ip=$(ssh remoteadmin@server1-mgmt --  grep "192.168.16.3" /var/log/syslog | wc -l)
n2entry=$(ssh remoteadmin@server1-mgmt --  grep "192.168.16.4 webhost" /var/log/syslog | wc -l)
echo "n2name=$n2name  n2ip=$n2ip  n2entry=$n2entry"
